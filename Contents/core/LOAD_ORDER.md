...
`gp_PikietaData.lsp` musi byc ladowany po `gp_PikietaStyle.lsp`, bo korzysta z funkcji tworzenia wariantow pikiet.
`gp_PikietaStyleOptimized.lsp` musi byc ladowany po `gp_PikietaData.lsp`, bo publiczne operacje stylu kieruje na model posredni `PikietaData`, runtime schematu i wspolny szybki writer tekstowy.
