...
11. `Contents/core/gp_PikietaData.lsp`
12. `Contents/core/gp_PikietaStyleOptimized.lsp`
13. `Contents/ui/gp_SetupDialog.lsp`
14. `Contents/ui/gp_SetupAutosave.lsp`
15. `Contents/ui/gp_SetupPrefix.lsp`
16. `Contents/ui/gp_SetupGroup.lsp`
17. `Contents/ui/gp_SetupMain.lsp`
18. `Contents/gp_Import.lsp`
19. `Contents/gp_Export.lsp`
20. `Contents/core/gp_ExportRadarCompat.lsp`
21. pozostale moduly funkcjonalne: wstawianie, niwelacje, siatka, usuwanie.
...
`gp_PikietaStyleOptimized.lsp` musi byc ladowany po `gp_PikietaData.lsp`, bo publiczne operacje stylu kieruje na model posredni `PikietaData`.
